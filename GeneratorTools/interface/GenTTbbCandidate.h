#ifndef GenTTbbCandidate_H
#define GenTTbbCandidate_H
...
namespace vallot{
  ...
  class GenTTbbCandidate{
  public:
    GenTTbbCandidate(){}
    virtual ~GenTTbbCandidate(){}
    ...
    void building( const std::vector<reco::GenJet>* genJets, const reco::GenParticleCollection* genParticles );
